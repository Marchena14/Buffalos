...
<html>
	...
	<body class="bodyTabla">
		...
		for($page=1; $page <= $total_pages; $page++){
			...
			<?php }else{ ?>
				<a href="paginaBuffalos.php?page_num=<?= $page ?>&page_size=<?=$page_size?>"><?=$page?></a>
			<?php 
		}
		}
		 ?>
		...
		<td>
			...
			<?php }else { ?>
			<button id="editar" name="editar" type="submit" class="editar_fila"><img src="images/pencil.png"></button>
			<?php } ?>
			</td>
