...
<html>
	...
	<body>
		...
		<div id="centrar">
		<a href="productos.php?page_num=<?= $page_num-1 ?>&page_size=<?=$page_size?>"><img src="images/btnatras.png"/></a>
		<a href="productos.php?page_num=<?= $page_num+1 ?>&page_size=<?=$page_size?>"><img src="images/btnalante.png"/></a>
		</div>
			</div>
				</div>
			</div>
