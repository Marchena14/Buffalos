		...
		<div class="menuCentral">
			...
			<div class="centralPrincipal">
				<div class="interiorPanel">
					...
					<div id="centrar"><a href="paqueteDiamante.php"><img src="images/diamante.jpg"/></a></div><br>
					<div id="centrar"><a href="paqueteOro.php"><img src="images/oro.jpg"/></a></div><br>
					<div id="centrar"><a href="paquetePlata.php"><img src="images/plata.jpg"/></a></div><br>
					<div id="centrar"><a href="paqueteBronce.php"><img src="images/bronce.jpg"/></a></div>
				</div>
			</div>
		</div>
	</body>
