<?php
    session_start();
	$_SESSION['paginaActual'] = "exitoBuffalos.php";
...
if(!isset($_SESSION['formulario'])){
	...
	$con = conectarBD();
	try{
	$stmt = $con -> prepare("CALL alta_buffalo(:nombre,:apellidos,:dni,to_date(:fechaNacimiento,'DD/MM/RR'),:telefono,:email,:direccion,:tipoBuffalo,:idInstituto)");
	...
	$stmt -> bindParam(":tipoBuffalo", $formulario['tipoBuffalo']);
	$stmt -> bindParam(":idInstituto", $formulario['instituto']);
	$stmt -> execute();
