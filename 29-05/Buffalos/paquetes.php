		...
		<div class="menuCentral">
			...
			<div class="centralPrincipal">
				<div class="interiorPanel">
					...
					<div><a href="paqueteDiamante.php">Diamante</a></div>
					<div><a href="paqueteOro.php">Oro</a></div>
					<div><a href="paquetePlata.php">Plata</a></div>
					<div><a href="paqueteBronce.php">Bronce</a></div>
				</div>
			</div>
		</div>
	</body>
